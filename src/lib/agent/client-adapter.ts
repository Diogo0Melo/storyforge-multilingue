    ...
    complete: async (messages, signal) => {
      ...
      const content = await chat(
        ...
        input.resolution.config,
        {
          ...
          // Agent protocol responses are structured; preserve the project
          // language gate for any textual final answer without injecting a
          // natural-language constraint into the JSON transport.
          outputKind: 'functional-structured',
          contextOverflowPolicy: 'reject',
        },
        signal,
