...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['空灵', '清冷', '苍茫', '禅意', '古朴'],
        optionLabelKeys: [
          'promptParams.tone.options.ethereal',
          'promptParams.tone.options.frigid',
          'promptParams.tone.options.vast',
          'promptParams.tone.options.zen',
          'promptParams.tone.options.archaic',
        ],
        default: '清冷', optional: true },
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['甜', '虐', '甜虐交织', '治愈', '克制', '炽热'],
        optionLabelKeys: [
          'promptParams.tone.options.sweet',
          'promptParams.tone.options.angst',
          'promptParams.tone.options.bittersweet',
          'promptParams.tone.options.healing',
          'promptParams.tone.options.restrained',
          'promptParams.tone.options.burning',
        ],
        default: '甜虐交织', optional: true },
      { key: 'pov', label: '视角', labelKey: 'promptParams.pov.label', type: 'select',
        options: ['女主单视角', '男主单视角', '双视角', '全知'],
        optionLabelKeys: [
          'promptParams.pov.options.femalePov',
          'promptParams.pov.options.malePov',
          'promptParams.pov.options.dualPov',
          'promptParams.pov.options.omniscient',
        ],
        default: '双视角', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 1500, max: 5000, step: 100, default: 2500, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['温情', '苍凉', '克制', '荒诞', '冷静', '怀旧'],
        optionLabelKeys: [
          'promptParams.tone.options.warm',
          'promptParams.tone.options.bleak',
          'promptParams.tone.options.restrained',
          'promptParams.tone.options.absurd',
          'promptParams.tone.options.detached',
          'promptParams.tone.options.nostalgic',
        ],
        default: '克制', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['冷峻', '诡谲', '紧绷', '阴郁', '机锋'],
        optionLabelKeys: [
          'promptParams.tone.options.grim',
          'promptParams.tone.options.eerie',
          'promptParams.tone.options.taut',
          'promptParams.tone.options.gloomy',
          'promptParams.tone.options.repartee',
        ],
        default: '冷峻', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 1500, max: 5000, step: 100, default: 2500, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['厚重', '权谋', '悲凉', '古雅', '激昂'],
        optionLabelKeys: [
          'promptParams.tone.options.weighty',
          'promptParams.tone.options.intrigue',
          'promptParams.tone.options.mournful',
          'promptParams.tone.options.classical',
          'promptParams.tone.options.rousing',
        ],
        default: '厚重', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 1500, max: 5000, step: 100, default: 2500, optional: true },
    ],
    isActive: false,
