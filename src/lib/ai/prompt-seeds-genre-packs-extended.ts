...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['热血', '霸气', '神秘', '黑暗', '搞笑'],
        optionLabelKeys: [
          'promptParams.tone.options.passionate',
          'promptParams.tone.options.domineering',
          'promptParams.tone.options.mysterious',
          'promptParams.tone.options.dark',
          'promptParams.tone.options.comedic',
        ],
        default: '热血', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['豪迈', '悲壮', '潇洒', '阴谋', '柔情'],
        optionLabelKeys: [
          'promptParams.tone.options.heroic',
          'promptParams.tone.options.tragic',
          'promptParams.tone.options.dashing',
          'promptParams.tone.options.scheming',
          'promptParams.tone.options.tender',
        ],
        default: '豪迈', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['轻松', '商战', '热血', '暗黑', '温情'],
        optionLabelKeys: [
          'promptParams.tone.options.relaxed',
          'promptParams.tone.options.corporate',
          'promptParams.tone.options.passionate',
          'promptParams.tone.options.darkGritty',
          'promptParams.tone.options.warm',
        ],
        default: '轻松', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
提醒：涉及真实历史内容时，请在段尾标注【史实·待核实】。用户在世界观中标注为"已核实"的条目不需要重复标注。`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['庄重', '权谋', '悲壮', '诙谐', '沉郁'],
        optionLabelKeys: [
          'promptParams.tone.options.solemn',
          'promptParams.tone.options.intrigue',
          'promptParams.tone.options.tragic',
          'promptParams.tone.options.witty',
          'promptParams.tone.options.somber',
        ],
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['硬核', '赛博', '太空歌剧', '末日', '哲思'],
        optionLabelKeys: [
          'promptParams.tone.options.hardcore',
          'promptParams.tone.options.cyber',
          'promptParams.tone.options.spaceOpera',
          'promptParams.tone.options.apocalyptic',
          'promptParams.tone.options.philosophical',
        ],
        default: '硬核', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['压抑', '热血', '温暖', '恐怖', '讽刺'],
        optionLabelKeys: [
          'promptParams.tone.options.oppressive',
          'promptParams.tone.options.passionate',
          'promptParams.tone.options.heartwarming',
          'promptParams.tone.options.horrific',
          'promptParams.tone.options.satirical',
        ],
        default: '压抑', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['轻松', '热血', '权谋', '种田', '治愈'],
        optionLabelKeys: [
          'promptParams.tone.options.relaxed',
          'promptParams.tone.options.passionate',
          'promptParams.tone.options.intrigue',
          'promptParams.tone.options.farming',
          'promptParams.tone.options.healing',
        ],
        default: '轻松', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['复仇', '温馨', '商战', '校园', '布局'],
        optionLabelKeys: [
          'promptParams.tone.options.vengeful',
          'promptParams.tone.options.cozy',
          'promptParams.tone.options.corporate',
          'promptParams.tone.options.campus',
          'promptParams.tone.options.longGame',
        ],
        default: '布局', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['爽快', '策略', '搞笑', '暗黑', '热血'],
        optionLabelKeys: [
          'promptParams.tone.options.cathartic',
          'promptParams.tone.options.strategic',
          'promptParams.tone.options.comedic',
          'promptParams.tone.options.darkGritty',
          'promptParams.tone.options.passionate',
        ],
        default: '爽快', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['紧张', '烧脑', '热血', '恐怖', '搞笑'],
        optionLabelKeys: [
          'promptParams.tone.options.tense',
          'promptParams.tone.options.mindBending',
          'promptParams.tone.options.passionate',
          'promptParams.tone.options.horrific',
          'promptParams.tone.options.comedic',
        ],
        default: '紧张', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['黑色电影', '反乌托邦', '热血', '阴郁', '讽刺'],
        optionLabelKeys: [
          'promptParams.tone.options.filmNoir',
          'promptParams.tone.options.dystopian',
          'promptParams.tone.options.passionate',
          'promptParams.tone.options.gloomy',
          'promptParams.tone.options.satirical',
        ],
        default: '黑色电影', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['诡异', '压抑', '疯狂', '绝望', '猎奇'],
        optionLabelKeys: [
          'promptParams.tone.options.uncanny',
          'promptParams.tone.options.oppressive',
          'promptParams.tone.options.frenzied',
          'promptParams.tone.options.desperate',
          'promptParams.tone.options.grotesque',
        ],
        default: '诡异', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['田园', '温馨', '轻松', '商业', '治愈'],
        optionLabelKeys: [
          'promptParams.tone.options.pastoral',
          'promptParams.tone.options.cozy',
          'promptParams.tone.options.relaxed',
          'promptParams.tone.options.commercial',
          'promptParams.tone.options.healing',
        ],
        default: '田园', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['宏大', '权谋', '热血', '悲壮', '谋略'],
        optionLabelKeys: [
          'promptParams.tone.options.grand',
          'promptParams.tone.options.intrigue',
          'promptParams.tone.options.passionate',
          'promptParams.tone.options.tragic',
          'promptParams.tone.options.cunning',
        ],
        default: '宏大', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['史诗', '黑暗', '轻松', '浪漫', '奇诡'],
        optionLabelKeys: [
          'promptParams.tone.options.epic',
          'promptParams.tone.options.dark',
          'promptParams.tone.options.relaxed',
          'promptParams.tone.options.romantic',
          'promptParams.tone.options.whimsical',
        ],
        default: '史诗', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
...
用户额外要求：{{userHint}}{{/if}}`,
    ...
    parameters: [
      { key: 'tone', label: '基调', labelKey: 'promptParams.tone.label', type: 'select',
        options: ['竞技', '冒险', '搞笑', '热血', '策略'],
        optionLabelKeys: [
          'promptParams.tone.options.competitive',
          'promptParams.tone.options.adventurous',
          'promptParams.tone.options.comedic',
          'promptParams.tone.options.passionate',
          'promptParams.tone.options.strategic',
        ],
        default: '竞技', optional: true },
      { key: 'chapterLength', label: '目标字数', labelKey: 'promptParams.chapterLength.label', type: 'slider',
        min: 2000, max: 5000, step: 100, default: 3000, optional: true },
    ],
    isActive: false,
