...
export const CONTEXT_SOURCES: ContextSource[] = [
  {
    ...
    key: 'projectStatus',
    label: '项目概况',
    labelKey: 'contextSource.projectStatus',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 1200,
  ...
  },
  {
    ...
    key: 'worldGroups',
    label: '世界组目录',
    labelKey: 'contextSource.worldGroups',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 1500,
  ...
  },
  {
    ...
    key: 'outlineTree',
    label: '大纲树',
    labelKey: 'contextSource.outlineTree',
    scope: 'world',
    layer: 'L2',
    budgetTokens: 6000,
  ...
  },
  {
    ...
    key: 'searchResults',
    label: '项目内搜索结果',
    labelKey: 'contextSource.searchResults',
    scope: 'world',
    layer: 'L2',
    budgetTokens: 2200,
    requiresWorldGroupId: true,
  ...
  },
  {
    ...
    key: 'ragSelection',
    label: '作者选择的资料字段',
    labelKey: 'contextSource.ragSelection',
    scope: 'manual',
    layer: 'L0',
  ...
  },
  {
    key: 'manualText',
    label: '用户指定内容',
    labelKey: 'contextSource.manualText',
    scope: 'manual',
    layer: 'L0',
    budgetTokens: 100_000,
  ...
  },
  {
    key: 'chapterContent',
    label: '章节正文',
    labelKey: 'contextSource.chapterContent',
    scope: 'chapter',
    layer: 'L0',
    budgetTokens: 100_000,
  ...
  },
  {
    key: 'contextMemo',
    label: '上下文快照',
    labelKey: 'contextSource.contextMemo',
    scope: 'project',
    layer: 'L3',
    budgetTokens: 1500,
  ...
  },
  {
    key: 'chapterOutline',
    label: '当前章节大纲',
    labelKey: 'contextSource.chapterOutline',
    scope: 'node',
    layer: 'L1',
    budgetTokens: 800,
  ...
  },
  {
    ...
    label: '已有卷大纲',
    labelKey: 'contextSource.existingVolumeOutlines',
    scope: 'project',
    layer: 'L1',
    budgetTokens: 2400,
  ...
  },
  {
    ...
    label: '本卷已写正文进度',
    labelKey: 'contextSource.writtenChapterProgress',
    scope: 'node',
    layer: 'L1',
    budgetTokens: 3000,
    protectedFromTrim: true,
  ...
  },
  {
    key: 'currentFacts',
    label: '当前有效事实(事实账本投影)',
    labelKey: 'contextSource.currentFacts',
    scope: 'chapter',
    layer: 'L1',
    budgetTokens: 2000,
    requiresChapterId: true,
  ...
  },
  {
    key: 'canonAssertions',
    label: '世界宪法(已确认设定断言)',
    labelKey: 'contextSource.canonAssertions',
    scope: 'world',
    layer: 'L1',
    budgetTokens: 1800,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '角色认知边界(认知账本投影)',
    labelKey: 'contextSource.characterKnowledge',
    scope: 'chapter',
    layer: 'L1',
    budgetTokens: 1600,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    labelKey: 'contextSource.retrievedPassages',
    scope: 'chapter',
    layer: 'L2',
    budgetTokens: 2500,
    requiresChapterId: true,
  ...
  },
  {
    key: 'detailedOutline',
    label: '本章细纲(场景拆解)',
    labelKey: 'contextSource.detailedOutline',
    scope: 'node',
    layer: 'L1',
    budgetTokens: 1500,
    requiresOutlineNodeId: true,
  ...
  },
  {
    ...
    label: '全局直接前驱原文尾部',
    labelKey: 'contextSource.previousChapterEnding',
    scope: 'manual',
    layer: 'L1',
    budgetTokens: 1800,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '全局直接前驱连续性交接',
    labelKey: 'contextSource.chapterContinuityHandoff',
    scope: 'chapter',
    layer: 'L1',
    budgetTokens: 1600,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '前章计划正文对账',
    labelKey: 'contextSource.previousPlanReconciliation',
    scope: 'chapter',
    layer: 'L1',
    budgetTokens: 1400,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '当前世界最近已验证摘要',
    labelKey: 'contextSource.recentChapterSummaries',
    scope: 'chapter',
    layer: 'L1',
    budgetTokens: 2200,
    requiresChapterId: true,
  ...
  },
  {
    key: 'worldview',
    label: '世界观',
    labelKey: 'contextSource.worldview',
    scope: 'world',
    layer: 'L2',
  ...
  },
  {
    key: 'storyCore',
    label: '故事核心',
    labelKey: 'contextSource.storyCore',
    scope: 'project',
    layer: 'L1',
  ...
  },
  {
    ...
    label: '当前生效角色驱动方案',
    labelKey: 'contextSource.characterDrivenPlan',
    scope: 'project',
    layer: 'L1',
    budgetTokens: 5000,
    protectedFromTrim: true,
  ...
  },
  {
    key: 'powerSystem',
    label: '力量体系',
    labelKey: 'contextSource.powerSystem',
    scope: 'world',
    layer: 'L2',
  ...
  },
  {
    key: 'characters',
    label: '角色档案',
    labelKey: 'contextSource.characters',
    scope: 'world',
    layer: 'L2',
  ...
  },
  {
    key: 'creativeRules',
    label: '创作规则',
    labelKey: 'contextSource.creativeRules',
    scope: 'project',
    layer: 'L1',
    budgetTokens: 1000,
  ...
  },
  {
    key: 'worldRules',
    label: '真实与幻想规则',
    labelKey: 'contextSource.worldRules',
    scope: 'world',
    layer: 'L1',
    budgetTokens: 1200,
    requiresWorldGroupId: true,
  ...
  },
  {
    key: 'historical',
    label: '历史时间线',
    labelKey: 'contextSource.historical',
    scope: 'world',
    layer: 'L2',
    budgetTokens: 1800,
    requiresWorldGroupId: true,
  ...
  },
  {
    key: 'locations',
    label: '重要地点',
    labelKey: 'contextSource.locations',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 1200,
  ...
  },
  {
    key: 'foreshadows',
    label: '伏笔状态',
    labelKey: 'contextSource.foreshadows',
    scope: 'chapter',
    layer: 'L2',
    budgetTokens: 1200,
  ...
  },
  {
    key: 'storyArcs',
    label: '故事线',
    labelKey: 'contextSource.storyArcs',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 1500,
  ...
  },
  {
    ...
    label: '作者确认的故事线进度与交汇',
    labelKey: 'contextSource.storylineProgress',
    scope: 'project',
    layer: 'L1',
    budgetTokens: 1400,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '作者确认的正文修炼进度',
    labelKey: 'contextSource.cultivationProgress',
    scope: 'world',
    layer: 'L1',
    budgetTokens: 1000,
    protectedFromTrim: true,
  ...
  },
  {
    key: 'emotionBeats',
    label: '情感节拍',
    labelKey: 'contextSource.emotionBeats',
    scope: 'chapter',
    layer: 'L1',
    budgetTokens: 1000,
    requiresChapterId: true,
  ...
  },
  {
    key: 'stateCards',
    label: '状态卡',
    labelKey: 'contextSource.stateCards',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 1800,
  ...
  },
  {
    key: 'itemLedger',
    label: '物品流水',
    labelKey: 'contextSource.itemLedger',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 2400,
  ...
  },
  {
    key: 'heldItems',
    label: '当前已持有物品',
    labelKey: 'contextSource.heldItems',
    scope: 'chapter',
    layer: 'L1',
    budgetTokens: 1000,
    protectedFromTrim: true,
  ...
  },
  {
    key: 'storyTimeline',
    label: '故事年表',
    labelKey: 'contextSource.storyTimeline',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 2600,
  ...
  },
  {
    ...
    label: '角色关系',
    labelKey: 'contextSource.characterRelations',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 2200,
  ...
  },
  {
    key: 'references',
    label: '引用手法',
    labelKey: 'contextSource.references',
    scope: 'project',
    layer: 'L3',
    budgetTokens: 2000,
  ...
  },
  {
    ...
    label: '我的文风',
    labelKey: 'contextSource.userStyleProfile',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 1800,
  ...
  },
  {
    ...
    label: '增量灵感工作区',
    labelKey: 'contextSource.inspirationWorkspace',
    scope: 'project',
    layer: 'L0',
    budgetTokens: 11_000,
  ...
  },
  {
    ...
    key: 'characterFacts',
    label: '该角色的剧情事实',
    labelKey: 'contextSource.characterFacts',
    scope: 'project',
    layer: 'L1',
    budgetTokens: 1500,
  ...
  },
  {
    ...
    label: '该角色的正文表现',
    labelKey: 'contextSource.characterPassages',
    scope: 'project',
    layer: 'L1',
    budgetTokens: 2500,
    enabled: input => !!input.subjectCharacterName?.trim(),
