...
export const CONTEXT_SOURCES: ContextSource[] = [
  {
    ...
    labelKey: 'outline:contextSources.worldGameAuthoring',
    label: '冻结世界游戏创作包',
    scope: 'project',
    layer: 'L1',
    ownerFrom: 'work',
  ...
  {
    key: 'avgAuthoring',
    labelKey: 'outline:contextSources.avgAuthoring',
    label: 'AVG 作者演出素材',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 4000,
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.adventureRuntime',
    label: '文字冒险玩家视角',
    scope: 'runtime',
    layer: 'L0',
    budgetTokens: 8000,
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.narrativeSimulationRuntime',
    label: '叙事模拟玩家视角',
    scope: 'runtime',
    layer: 'L0',
    budgetTokens: 8000,
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.openWorldRuntime',
    label: '文字开放世界玩家视角',
    scope: 'runtime',
    layer: 'L0',
    budgetTokens: 8000,
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.interactionRuntime',
    label: '角色互动单一视角',
    scope: 'runtime',
    layer: 'L0',
    budgetTokens: 8000,
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.codexExtractionBaseline',
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.historyAgentBaseline',
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.referenceDerivedBaseline',
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.styleLearningBaseline',
    label: '文风学习正式输入基线',
    scope: 'project',
    layer: 'L0',
    budgetTokens: 28_000,
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.priorOutlineCandidate',
    label: '同批次上一卷章纲候选',
    scope: 'runtime',
    layer: 'L1',
    budgetTokens: 2400,
  ...
  },
  {
    ...
    labelKey: 'outline:contextSources.cultivationProgressExtractionBaseline',
  ...
  },
  {
    ...
    label: '相邻章纲',
    labelKey: 'outline:contextSources.adjacentChapterOutlines',
    scope: 'node',
    layer: 'L1',
    budgetTokens: 1000,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '大纲标题与摘要（分析）',
    labelKey: 'outline:contextSources.outlineSummaries',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 6_000,
    requiresWorldGroupId: true,
  ...
  },
  {
    key: 'writtenChapters',
    label: '已写章节正文（分析摘录）',
    labelKey: 'outline:contextSources.writtenChapters',
    scope: 'project',
    layer: 'L2',
    budgetTokens: 8_000,
    requiresWorldGroupId: true,
  ...
  },
  {
    ...
    label: '世界宪法扫描来源闭集',
    labelKey: 'outline:contextSources.constitutionScanSources',
    scope: 'project',
    layer: 'L0',
    budgetTokens: 30_000,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '长期一致性档案',
    labelKey: 'outline:contextSources.consistencyDossier',
    scope: 'chapter',
    layer: 'L1',
    budgetTokens: 6_000,
    protectedFromTrim: true,
  ...
  },
  {
    key: 'geography',
    label: '地理环境',
    labelKey: 'outline:contextSources.geography',
    scope: 'world',
    layer: 'L2',
    budgetTokens: 3_000,
    requiresWorldGroupId: true,
  ...
  },
  {
    ...
    label: '当前选定叙事蓝图',
    labelKey: 'outline:contextSources.activeNarrativeBlueprint',
    scope: 'project',
    layer: 'L1',
    budgetTokens: 5000,
    protectedFromTrim: true,
  ...
  },
  {
    key: 'targetCharacter',
    label: '本次目标角色完整设定',
    labelKey: 'outline:contextSources.targetCharacter',
    scope: 'world',
    layer: 'L0',
    budgetTokens: 8_000,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '伏笔建议正式基线',
    labelKey: 'outline:contextSources.foreshadowSuggestionBaseline',
    scope: 'project',
    layer: 'L0',
    budgetTokens: 8_000,
    protectedFromTrim: true,
  ...
  },
  {
    ...
    label: '目标故事年表事件',
    labelKey: 'outline:contextSources.storyTimelineTarget',
    scope: 'project',
    layer: 'L1',
    budgetTokens: 600,
    protectedFromTrim: true,
