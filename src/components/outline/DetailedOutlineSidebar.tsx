          ...
          {chapters.map(chapter => (
            ...
            >
              ...
              {chapter.id != null && detailedNodeIds.has(chapter.id) && (
                <span className="w-1.5 h-1.5 rounded-full bg-success flex-shrink-0" title={t('detailed.hasDetail')} />
              )}
            </button>
          ))}
        </div>
          ...
          {!batchProgress ? (
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-1.5">
                ...
                <button onClick={onBatchStop} className="p-0.5 text-error hover:text-error/80" title={t('detailed.stopAria')}>
